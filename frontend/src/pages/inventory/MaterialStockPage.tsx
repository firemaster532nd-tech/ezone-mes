          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {loading ? (
                ...
                const { pureLotNumber, locationText } = parsePureLotAndLocation(lot.lot_number, lot.location);
                return (
                  <tr key={lot.lot_id} className="hover:bg-slate-50">
                    ...
                    <td className="px-3 py-2 font-mono text-xs font-bold text-blue-700 whitespace-nowrap">{pureLotNumber}</td>
                    ...
                    <td className="px-3 py-2"><span className="px-1.5 py-0.5 bg-blue-50 text-blue-700 rounded text-xs font-mono font-bold">{fmtLoc(locationText)}</span></td>
