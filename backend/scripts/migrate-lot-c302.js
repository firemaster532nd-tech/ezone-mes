...
const SUBL_LOTS_TO_INSERT = [
  ...
  // ── 차열시트 배합공정 (S) ──────────────────────────────────
  { lot_number: '260129-S04',  lot_type: 'PROC', item_id: 16, note: '배합공정' },
  { lot_number: '260203-S01',  lot_type: 'PROC', item_id: 16, note: '배합공정' },
  { lot_number: '260203-S05',  lot_type: 'PROC', item_id: 16, note: '배합공정(소켓용)' },
  { lot_number: '260203-S08',  lot_type: 'PROC', item_id: 16, note: '배합공정(플래싱용)' },
  { lot_number: '260205-S01',  lot_type: 'PROC', item_id: 21, note: '재단공정' },
  { lot_number: '260205-S02',  lot_type: 'PROC', item_id: 21, note: '재단공정' },
  { lot_number: '260210-S01',  lot_type: 'PROC', item_id: 16, note: '배합공정' },
  { lot_number: '260223-S01',  lot_type: 'PROC', item_id: 21, note: '재단공정' },
  { lot_number: '260119-S07',  lot_type: 'PROC', item_id: 21, note: '재단공정' },
