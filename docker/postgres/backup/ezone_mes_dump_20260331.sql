...
\restrict E76FlzuJngWXBmHQNTywirnCZhklZMjYDGAzjosSbxrqDKj6Y3RwBLGZHtEvHMg
...
1	SO-260303-001	2026-03-03	㈜하나로엔지니어링	인천검단101역세권C1현장	\N	BOM_EXPLODED	9	엑셀업로드: 주문서	2026-03-31 03:10:26.275538+00
\.
...
SELECT pg_catalog.setval('public.certification_master_cert_id_seq', 164, true);
...
SELECT pg_catalog.setval('public.inspection_detail_detail_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.inspection_insp_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.item_master_item_id_seq', 5702, true);
...
SELECT pg_catalog.setval('public.lot_transaction_lot_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.process_bom_bom_id_seq', 1092, true);
...
SELECT pg_catalog.setval('public.purchase_request_item_pri_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.purchase_request_pr_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.work_order_wo_id_seq', 1, false);
...
\unrestrict E76FlzuJngWXBmHQNTywirnCZhklZMjYDGAzjosSbxrqDKj6Y3RwBLGZHtEvHMg
